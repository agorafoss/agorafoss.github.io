  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "note",
          text: "No 0.2 o signaling do palco (kinds 20xxx) não vai para Damus, purplepag.es nem relays de grupo — eles recusam e enchiam o F12. Vai para nos.lol, primal e offchain.pub. Chat continua nos relays da lista.",
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "note",
          text: "In 0.2, stage signaling (kinds 20xxx) does not go to Damus, purplepag.es or group relays — they reject it and flooded the console. It goes to nos.lol, primal and offchain.pub. Chat still uses the list in settings.",
        },
      ],
    },
    {
