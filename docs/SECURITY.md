...
Rodar relay + LiveKit + MediaMTX + Blossom é recinto. Quem sobe assume a exposição legal da própria jurisdição, a moderação do que passa nas peças e o gargalo de um MediaMTX de nó único. Guia curto: [`HOSPEDAR.md`](./HOSPEDAR.md).
