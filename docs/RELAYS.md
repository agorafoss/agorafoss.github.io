...
5. Palco: SDP/ICE entre pares. Relays genéricos costumam **bloquear** os kinds de signaling (purplepag.es, groups.fiatjaf.com sem tag `h`, Damus com rate-limit). A malha precisa de pelo menos um `wss://` que aceite o evento. O seu NIP-29 costuma ser o lugar certo — se a política deixar.
